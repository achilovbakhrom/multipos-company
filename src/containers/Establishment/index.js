...
import {config} from "./validation/establishment-validation";
...
import {addEstablishment} from '../../actions/addEstablishment';
...
function mapStateToProps(state) {
    return{
        addedEstablishment: state.addedEstablishment
    }
}

export default connect(mapStateToProps, {addEstablishment}) (withStyles(styles)(Establishment));